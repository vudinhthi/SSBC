...
{
    public static partial class SSBCMixVouchers
    {
        ...
        public static SSBC_Data.SourceContext.MSG Delete(IEnumerable<SSBC_Data.Entities.SSBCMixVouchers> items)
        {
            var _return = new SSBC_Data.SourceContext.MSG();
            try
            {
                ...
                {
                    var itemDel = dbContext.SSBCMixVouchers.Where(s => s.VoucherId == item.VoucherId).FirstOrDefault();
