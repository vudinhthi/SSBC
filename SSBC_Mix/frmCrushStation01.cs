...
namespace SSBC_Mix
{
    public partial class frmCrushStation01 : Form
    {
        public frmCrushStation01()
        {
            InitializeComponent();
            UserInitialization();
        }
        ...
        private void frmCrushStation01_Load(object sender, EventArgs e)
        {
        ...
        private void txtBarcode_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                else
                {
                    ...
                    _ScannerInfo = dbContext.Database.SqlQuery<ScannerInfo>("dbo.sp_CrushStation_GetData @Barcode,@ScaleWeight", Para_Barcode, Para_ScaleWeight).FirstOrDefault();
