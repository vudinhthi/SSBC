...
{
    public partial class rptLabelBarcodeRunner : DevExpress.XtraReports.UI.XtraReport
    {
        public rptLabelBarcodeRunner()
        {
            InitializeComponent();
        }
        ...
        public void LoadDetail()
        {
            ...
            this.txtMaterialName.DataBindings.Add(new DevExpress.XtraReports.UI.XRBinding("Text", null, "MaterialCo"));
        ...
        private void rptLabelBarcodeRunner_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
