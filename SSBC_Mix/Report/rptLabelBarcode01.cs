...
{
    public partial class rptLabelBarcode01 : DevExpress.XtraReports.UI.XtraReport
    {
        public rptLabelBarcode01()
        {
            InitializeComponent();
        }
        ...
        public void Load(List<SSBC_Data.Extend.LabelTemplate> List)
        {
            ...
            {
                Item.MaterialType = Item.MaterialType == "CP" ? "COMPOUNDED" : "NON-CP";
            }
